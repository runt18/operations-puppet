...
class ServiceStats(object):
    ...
    def _proc_stats(process):
        ...
        # OTOH "top" samples cpu usage between intervals, so let's sample (and
        # block) for CPU_SAMPLE_INTERVAL seconds
    ...
    def _merge_stats(stats, child_stats):
        ...
        for stat_name in child_stats:
            # report the earliest create_time, sum everything else
